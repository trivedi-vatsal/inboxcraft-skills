...
| **`inboxcraft-outlook-export-rules`** | `1.1.0` | Gathers Outlook inbox rules and exports them to a JSON or CSV file for sharing or backup. | *"Export all my Outlook rules to a CSV file on my desktop."* |
| **`inboxcraft-outlook-show-folders`** | `1.1.0` | Recursively traverses and prints the visual tree-like hierarchy of the Outlook inbox. | *"Print out the full folder tree structure of my Outlook inbox."* |
| **`inboxcraft-outlook-export-folders`** | `1.1.0` | Recursively reads the Outlook folder structure and exports paths and item counts to a file. | *"Export my Outlook folder hierarchy to a JSON file."* |
