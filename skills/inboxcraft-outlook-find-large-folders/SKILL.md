...
This skill instructs the agent on how to write a PowerShell script that inspects a user's Outlook profile to find the largest folders, with Exchange Online fallback fallback.

## When to Use

Use this skill whenever the user asks to "find my large outlook folders", "show me where my space is going", or "find bulky folders".

## Steps

1. **Inform the User:** Start by telling the user that you are generating a script.
